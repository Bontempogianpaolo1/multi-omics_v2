...
path_annotation = "original/stomach/anomalies_annotation_global.csv"
path_meth = "original/stomach/anomalies_Matrix_meth.csv"
max_features = 5000
...
data2["Composite Element REF"] = index
data2 = data2.sort_values(by="Composite Element REF").drop(columns="Composite Element REF")
data2.to_csv("./data/anomalies_Matrix_" + filenames[1] + ".csv", index=False, header=False)
# data=data[data_onlyvalues.std().sort_values(ascending=False).head(max_features).index]
data = pd.DataFrame(
    stats.zscore(data[data_onlyvalues.std().sort_values(ascending=False).head(max_features).index].values.tolist()))
data["Composite Element REF"] = index
...
data = data.sort_values(by="Composite Element REF").drop(columns="Composite Element REF")
data.to_csv("./data/anomalies_preprocessed_Matrix_" + filenames[1] + ".csv", index=False, header=False)
...
data2["Composite Element REF"] = index
data2 = data2.sort_values(by="Composite Element REF").drop(columns="Composite Element REF")
data2.to_csv("./data/anomalies_Matrix_" + filenames[2] + ".csv", index=False, header=False)
# data=data[data_onlyvalues.std().sort_values(ascending=False).head(max_features).index]
data = pd.DataFrame(
    stats.zscore(data[data_onlyvalues.std().sort_values(ascending=False).head(max_features).index].values.tolist()))
data["Composite Element REF"] = index
...
data = data.sort_values(by="Composite Element REF").drop(columns="Composite Element REF")
data.to_csv("./data/anomalies_preprocessed_Matrix_" + filenames[2] + ".csv", index=False, header=False)
